...
exports.serializeMessage = async (client, msg) => {
  if (!msg) return;
  ...
  if (msg.message) {
    ...
    if (["ephemeralMessage", "documentWithCaptionMessage"].includes(msg.type)) {
      await exports.serializeMessage(client, msg.content);
    ...
    try {
      msg.quoted = client?.store
        ? exports.serializeMessage(
            client,
            await client.store.loadMessage(
      ...
      if (!msg.quoted && q) {
        msg.quoted = exports.serializeMessage(
          client,
