...
exports.serializeMessage = (msg) => {
  ...
  if (msg.content && typeof msg.content == "object") {
    ...
    if (msg.hasQuotedMessage) {
      ...
      msg.quoted.type = getContentType(msg.quoted) || Object.keys(msg.quoted)[0];
      msg.quoted.content = extractMessageContent(msg.quoted)[msg.quoted.type] || msg.quoted[msg.quoted.type];
      if (typeof msg.quoted.content == "string") msg.quoted.content = { text: msg.quoted.content }
