import { Cookie, HTTPRequest, Language, USER_GAMES_LIST, DEFAULT_REFERER, getHsrRegion, getGenshinRegion, getHi3Region } from "@rexprjkt/hoyoapi";
        ...
        this.region =
            this.uid !== null && this.gameType == "hsr"
                ...
                : this.uid !== null && this.gameType == "gi"
                    ? getGenshinRegion(this.uid)
                    : this.uid !== null && this.gameType == "hi3"
                        ? getHi3Region(this.uid)
                        : null;
