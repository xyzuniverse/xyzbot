...
module.exports = async(client, messages) => {
    ...
    let header_sender = chalk[pickRandom(colors)]("~ " + user.pushname + " " + PhoneNumber("+" + messages.id.participant.split('@c.us')[0]).getNumber("international")) + " to " + chalk.green(messages.from + " " + chats.name) + " " +  chalk.black(chalk.bgYellow(messages.type))
