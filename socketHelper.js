...
exports.messageHelper = (conn, m) => {
    ...
    if (type === 'ephemeralMessage') {
        type = getContentType(m.message[type].message) || Object.keys(m.message[type].message)[0]
    ...
    if (messageContent && typeof messageContent === 'object') {
       ...
       if (messageContent?.contextInfo?.quotedMessage) {
           let qtype = getContentType(messageContent.contextInfo.quotedMessage) || Object.keys(messageContent.contextInfo.quotedMessage)[0]
